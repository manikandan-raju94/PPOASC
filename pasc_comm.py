...
from traffic_env_comm import GridMarlEnv
...
def main():
    ...
    try:
        ...
        # Save final model
        save_path = os.path.join(ROOT, "models", f"{experiment_name}_comm.zip")
       ...
       # ------------------------------------------------
        ...
        try:
            crash_path = os.path.join(ROOT, "models", f"{experiment_name}_comm.zip")
